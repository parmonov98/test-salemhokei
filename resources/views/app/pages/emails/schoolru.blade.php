                                            ...
                                            <tr>
                                                <td align="center" valign="middle">
                                                    <div>
                                                        ...
                                                        <p>Вам пришло сообщение с сайта, от {{$data}}
                                                        </p>

                                                        <p><img src="{{ asset('assets/img/mails/ru/boshi.jpg')}}">   </p>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: center;">
                                                                    <a href="{{ env('DOWNLOAD_BUTTON_FROM_MAIL', '/') }}"
                                                                       class="" target="_blank" rel="noopener" style="">
                                                                        ...
                                                                        <img src="{{ asset('assets/img/mails/download-button-ru.png')}}"/>
                                                                    </a>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <a href="{{env('SUBSCRIBE_BUTTON_FROM_MAIL', '/')}}"
                                                                       class="" target="_blank" rel="noopener" style="">
                                                                        <img src="{{ asset('assets/img/mails/subscribe-button-ru.png')}}"/>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        ...
                                                        <p><img src="{{ asset('assets/img/mails/ru/oxiri.jpg')}}">  </p>
