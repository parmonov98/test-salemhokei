        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $term ? 'Результат поиска': 'Список видео' }}</h2>
                        ...
                        <div class="x_content">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td><a href="/admin/video/{{$item->id}}">{{ $item->name_ru }}</a></td>
                            ...
                            @else
                                ...
                                <center>Показать <strong><a href="/admin/videos">список всех видео</a></strong></center>
                            @endif
                        </div>
