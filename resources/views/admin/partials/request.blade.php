...
<div id="goalkeeper" class="form-modal" style="display:none">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#russian">Русский</a></li>
        <li><a data-toggle="tab" href="#kazakh">Қазақша</a></li>
    </ul>
...
<div id="forward" class="form-modal" style="display:none">
    ...
    <p>{!! __("default.pages.about.forward_content") !!}</p>
</div>
...
<div id="hockey_goal" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.hockey_goal_title") }}</h4>
    <p>{{ __("default.pages.main.hockey_goal_content") }}</p>

</div>

<div id="referee_field" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.referee_field_title") }}</h4>
    <p>{!! __("default.pages.main.referee_field_content") !!}</p>
</div>

<div id="washer_field" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.washer_field_title") }}</h4>
    <p>{!! __("default.pages.main.washer_field_content") !!}</p>
</div>
...
<div id="scoreboard" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.scoreboard_title") }}</h4>
    <p>{!! __("default.pages.main.scoreboard_content") !!}</p>
</div>

<div id="ice_machine" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.ice_machine_title") }}</h4>
    <p>{!! __("default.pages.main.ice_machine_content") !!}</p>
</div>

<div id="tribune" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.tribune_title") }}</h4>
    <p>{!! __("default.pages.main.tribune_content") !!}</p>
</div>

<div id="tribune" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.tribune_title") }}</h4>
    <p>{!! __("default.pages.main.tribune_desc") !!}</p>
</div>

<div id="bench" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.bench_title") }}</h4>
    <p>{!! __("default.pages.main.bench_desc") !!}</p>
</div>

<div id="penalty_box" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.penalty_box_title") }}</h4>
    <p>{!! __("default.pages.main.penalty_box_desc") !!}</p>
</div>

<div id="zone_a" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.zone_a_title") }}</h4>
    <p>{!! __("default.pages.main.zone_a_desc") !!}</p>
</div>

<div id="zone_b" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.zone_b_title") }}</h4>
    <p>{!! __("default.pages.main.zone_b_desc") !!}</p>
</div>

<div id="zone_c" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.main.zone_c_title") }}</h4>
    <p>{!! __("default.pages.main.zone_c_desc") !!}</p>
</div>
...
<div id="equipment_shorts" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.equipment.shorts") }}</h4>
    {!! __("default.pages.equipment.shorts_content") !!}
    {!! __("default.pages.equipment.shorts_video") !!}

</div>

<div id="equipment_stick" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.equipment.stick") }}</h4>
    {!! __("default.pages.equipment.stick_content") !!}
    {!! __("default.pages.equipment.stick_video") !!}

</div>

<div id="equipment_skates" class="form-modal" style="display:none">
    <h4 class="title-primary text-center">{{ __("default.pages.equipment.skates") }}</h4>
    {!! __("default.pages.equipment.skates_content") !!}
    {!! __("default.pages.equipment.skates_video") !!}
