                                            ...
                                            <tr>
                                                <td align="center" valign="middle">
                                                    <div>
                                                        ...
                                                        <p style="font-size: 16px;">На сайте <b>CCLTD.KZ</b> был изменен статус
                                                            договора <b>№{{ $number }}</b></p>
                                                        <p style="font-size: 16px;">Статус договора:
                                                            <b>{{ $status  }}</b></p>
                                                        <p style="font-size: 16px;">Текущий статус договора можно узнать
                                                            в личном кабинете, для этого вам
