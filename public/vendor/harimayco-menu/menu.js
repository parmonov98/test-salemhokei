...
function addcustommenu() {
    ...
    $.ajax({
        data: {
            ...
            labelmenu_kk: $('#custom-menu-item-name_kk').val(),
            labelmenu_ru: $('#custom-menu-item-name_ru').val(),
    ...
    if (id) {
        ...
        $('.menu-item-settings').each(function (k, v) {
            ...
            var label = $(this)
                ...
                .val();
            var label_kk = $(this)
                .find('.edit-menu-item-title_kk')
                .val();
            var label_ru = $(this)
                .find('.edit-menu-item-title_ru')
                .val();
            var clases = $(this)
            ...
            var url = $(this)
                ...
                .val();
            var url_kk = $(this)
                .find('.edit-menu-item-url_kk')
                .val();
            var url_ru = $(this)
                .find('.edit-menu-item-url_ru')
                .val();
            var role = $(this)
