<footer class="footer">
    <div class="container">
        <div class="row row--multiline">
            <div class="col-sm-6">
                <p><?php echo __("default.pages.footer.description"); ?>

            </div>
            <div class="col-sm-6">
                <p><?php echo __("default.pages.footer.address"); ?> <br>
                    Тел: <a href="tel:8 (717-2) 60-50-41" title="8 (717-2) 60-50-41">8 (717-2) 60-50-41</a><br>

                    E-mail: <a href="mailto:office@icehockey.kz" title="office@icehockey.kz">office@icehockey.kz</a></p>
            </div>

        </div>
        <div class="row row--multiline mt-5">
            <div class="col-sm-6 mt-4">
                    © <?php echo e(now()->year); ?> Salem Hokei</p>
            </div>
