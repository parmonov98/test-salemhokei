<?php $__env->startSection("title",__("default.site_name").' | '.__("default.pages.header.about")); ?>
                    ...
                    <div class="row row--multiline">
                        <div class="col-md-7 col-sm-6">
                            <div class="plain-text">
                                <h3><?php echo __("default.pages.about.block_title_1"); ?></h3>
                                <?php echo __("default.pages.about.block_desc_1"); ?>
                    ...
                    <div class="row row--multiline">
                        <div class="col-md-7 col-sm-6">
                            <div class="plain-text">
                                <h3 style="
    text-align: right;
"><?php echo __("default.pages.about.block_title_2"); ?></h3>
                                <?php echo __("default.pages.about.block_desc_2"); ?>
...
"> <?php echo __("default.pages.about.block_title_3"); ?> </h3>
                    <div class="plain-text plain-text__20">
                        <?php echo __("default.pages.about.block_desc_3"); ?>
...
"><span style="
    padding-left: 1.8em;
    padding-top: 1.4em;
"><?php echo __("default.pages.about.block_title_5"); ?> <img src="/assets/img/girl-icon.svg" alt="" style="
...
"></h3> 
                    ...
                    <div class="plain-text plain-text__20">
                        <?php echo __("default.pages.about.block_desc_5"); ?>
        ...
        <div class="container">
            ...
            <div class="row row--multiline">
                <div class="col-sm-6 col-md-3 col-xs-6">
                    <a href="#hockey_goal" title="<?php echo e(__("default.pages.main.hockey_goal_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-1.svg" alt=""></a>
                    <a href="#referee_field" title="<?php echo e(__("default.pages.main.referee_field_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-2.svg" alt=""></a>
                    <a href="#washer_field" title="<?php echo e(__("default.pages.main.washer_field_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-3.svg" alt=""></a>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-sm-6 col-md-3 col-xs-6">
                    <a href="#scoreboard" title="<?php echo e(__("default.pages.main.scoreboard_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-4.svg" alt=""></a>
                    <a href="#ice_machine" title="<?php echo e(__("default.pages.main.ice_machine_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-5.svg" alt=""></a>
                    <a href="#tribune" title="<?php echo e(__("default.pages.main.tribune_title")); ?>" data-fancybox="" class="field-item"><img src="/assets/img/field/field-item-6.svg" alt=""></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            ...
            <div class="plain-text plain-text__18">
                <?php echo __("default.pages.about.block_desc_4"); ?>

            </div>

            <div class="roles">
                <a href="#goalkeeper" title="<?php echo __("default.pages.about.goalkeeper_title"); ?>" data-fancybox="roles" class="roles-item">
                    <img src="/assets/img/goalkeeper.svg" alt="">
                    <span><?php echo __("default.pages.about.goalkeeper_title"); ?></span>
                </a>
                <a href="#forward" title="<?php echo __("default.pages.about.forward_title"); ?>" data-fancybox="roles" class="roles-item" style="margin-left: -3rem;">
                    <img src="/assets/img/striker.svg" alt="">
                    <span><?php echo __("default.pages.about.forward_title"); ?></span>
                </a>
                <a href="#defender" title="<?php echo __("default.pages.about.defender_title"); ?>" data-fancybox="roles" class="roles-item">
                    <img src="/assets/img/defender.svg" alt="">
                    <span><?php echo __("default.pages.about.defender_title"); ?></span>
                </a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make("app.layout.index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/botdev/www/salemhokei.botdev.uz/public/resources/views/app/pages/about.blade.php ENDPATH**/ ?>