                        ...
                        <div class="wrap">
                            ...
                            <div class="manage-menus">
                                <form method="get" action="<?php echo e($currentUrl); ?>">
                                    ...
                                    <?php echo AdminMenu::select('menu', $menulist); ?>
                                    ...
                                    <span class="add-new-menu-action"> or <a
                                            href="<?php echo e($currentUrl); ?>?action=edit&menu=0">Создать новое
                                             меню</a>. </span>
                                </form>
                            </div>
                                                                ...
                                                                <p id="menu-item-role_id-wrap">
                                                                    <label class="howto" for="custom-menu-item-name">
                                                                        ...
                                                                        <select id="custom-menu-item-role" name="role">
                                                                            ...
                                                                            <option value="<?php echo e($role->$role_pk); ?>">
                                                            ...
                                                            <li id="menu-item-<?php echo e($m->id); ?>"
                                                                ...
                                                                <dl class="menu-item-bar">
                                                                    <dt class="menu-item-handle">
                                                                        <span class="item-title"> <span
                                                                                ...
                                                                                style="<?php if($m->depth == 0): ?> display: none; <?php endif; ?>">Subelement</span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item-settings"
                                                                    ...
                                                                    <p class="description description-thin">
                                                                        <label for="edit-menu-item-title-<?php echo e($m->id); ?>">
                                                                            Label
                                                                            <br>
                                                                            <input type="text"
                                                                    ...
                                                                    <p class="description description-thin">
                                                                        <label for="edit-menu-item-title-<?php echo e($m->id); ?>">
                                                                            ...
                                                                            <input type="text"
                                                                                id="idlabelmenu_<?php echo e($m->id); ?>"
                                                                                class="widefat edit-menu-item-title_kk"
                                                                                name="idlabelmenu_<?php echo e($m->id); ?>"
                                                                                value="<?php echo e($m->label_kk); ?>">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <label for="edit-menu-item-url-<?php echo e($m->id); ?>">
                                                                            ...
                                                                            <input type="text"
                                                                                id="url_menu_<?php echo e($m->id); ?>"
                                                                                class="widefat code edit-menu-item-url_kk"
                                                                                id="url_menu_<?php echo e($m->id); ?>"
                                                                                value="<?php echo e($m->link_kk); ?>">
                                                                        </label>
                                                                    </p>
                                                                    <p class="description description-thin">
                                                                        <label for="edit-menu-item-title-<?php echo e($m->id); ?>">
                                                                            ...
                                                                            <input type="text"
                                                                                id="idlabelmenu_<?php echo e($m->id); ?>"
                                                                                class="widefat edit-menu-item-title_ru"
                                                                                name="idlabelmenu_<?php echo e($m->id); ?>"
                                                                                value="<?php echo e($m->label_ru); ?>">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <label for="edit-menu-item-url-<?php echo e($m->id); ?>">
                                                                            ...
                                                                            <input type="text"
                                                                                id="url_menu_<?php echo e($m->id); ?>"
                                                                                class="widefat code edit-menu-item-url_ru"
                                                                                id="url_menu_<?php echo e($m->id); ?>"
                                                                                value="<?php echo e($m->link_ru); ?>">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <label for="edit-menu-item-role-<?php echo e($m->id); ?>">
                                                                            Role
                                                                            <br>
                                                                            <select id="role_menu_<?php echo e($m->id); ?>"
                                                                                class="widefat code edit-menu-item-role"
                                                                                name="role_menu_[<?php echo e($m->id); ?>]">
                                                                                <option value="0">Select Role</option>
                                                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option <?php if($role->id == $m->role_id): ?>
                                                                                    selected <?php endif; ?>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a class="item-delete submitdelete deletion"
                                                                            ...
                                                                            href="<?php echo e($currentUrl); ?>?action=delete-menu-item&menu-item=<?php echo e($m->id); ?>&_wpnonce=2844002501">Delete</a>
                                                                        <span class="meta-sep hide-if-no-js"> | </span>
                                                                        <a class="item-cancel submitcancel hide-if-no-js button-secondary"
                                                                            id="cancel-<?php echo e($m->id); ?>"
                                                                            href="<?php echo e($currentUrl); ?>?edit-menu-item=<?php echo e($m->id); ?>&cancel=1424297719#menu-item-settings-<?php echo e($m->id); ?>">Cancel</a>
                                                                        <span class="meta-sep hide-if-no-js"> | </span>
                                                                        <a onclick="getmenus()"
...
<?php /**PATH /home/dev/Documents/laravel/test.salemhokei.kz/resources/views/vendor/wmenu/menu-html.blade.php ENDPATH**/ ?>